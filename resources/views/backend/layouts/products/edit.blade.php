...
<div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between p-3">
                <h5 class="text-center"><b>Product update Form</b></h5>
              ...
              <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" name="name" class="form-control" id="product" value="{{ $product->name }}" placeholder="Enter Name" >
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" name="quantity" class="form-control" id="qty" value="{{ $product->quantity }}" placeholder="Enter Quantity" >
                </div>
                <div class="col-md-12">
                  <label for="subcategory" class="form-label">Category Name :</label>
                    <select name="sub_category_id" class="form-control" id="subcategory">
                      ...
                      @forelse ($subcategories as $subcategory)
                        <option  @if ($product->sub_category_id == $subcategory->id) selected
